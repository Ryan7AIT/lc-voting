...
class StatusFiltersTest extends TestCase
{
    ...
    public function filtering_works_when_query_string_in_place()
    {
        ...
        $response->assertSee('<div class="px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-yellow text-xxs w-28 h-7">In Progress</div>', false);
        $response->assertDontSee('<div class="px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-purple text-xxs w-28 h-7">Considering</div>', false);
    }
